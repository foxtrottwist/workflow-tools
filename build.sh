...
SKILLS=(iter writing prompt-dev chat-migration code-audit azure-devops sharpen tdd systematic-debugging worktree swift-dev swift-concurrency swiftui-expert-skill axiom-accessibility-diag axiom-foundation-models-ref axiom-swift-testing axiom-swiftdata axiom-swiftui-26-ref axiom-swiftui-debugging)
