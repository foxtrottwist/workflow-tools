...
SKILLS=(iter writing prompt-dev chat-migration code-audit azure-devops skill-creator sharpen tdd systematic-debugging worktree swift-dev swift-concurrency swiftui-expert-skill swift-conventions axiom-accessibility-diag axiom-foundation-models-ref axiom-swift-testing axiom-swiftdata axiom-swiftui-26-ref axiom-swiftui-debugging)
